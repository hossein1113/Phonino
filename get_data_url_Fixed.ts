...
// ];
const urlToCall_to_get_up_page_one : Array<string> = [`https://digido.ir/3-mobile#/page-`,
...
const counter_up_page = [6, 6, 1, 6, 6];
const string_to_call = ['digido', 'alldigital', 'alldigital', 'digikala', 'technolife'];
let counter = 0;
...
function Iterate_Containers(count) : void {
    // console.log('sdsd');
    let m = new Nightmare({
        width: 1600,
        height: 900,
